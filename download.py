...
parser.add_argument('--datasets', metavar='N',
...
def download_celeb_a(dirpath):
    ...
    anno_filename, drive_id = "list_attr_celebs.txt", "0B7EVK8r0v71pblRyaVFSWGxPY0U"
    anno_save_path = os.path.join(dirpath, anno_filename)

    if os.path.exists(save_path):
        print('[*] {} already exists'.format(anno_save_path))
    else:
        download_file_from_google_drive(drive_id, anno_save_path)
